...
Welcome to `text_fancipy` contributor's guide.
...
If you experience bugs or general issues with `text_fancipy`, please have a look
...
You can help improve `text_fancipy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`text_fancipy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `text_fancipy`'s files. While this mechanism can
...
```
conda create -n text_fancipy python=3 six virtualenv pytest pytest-cov
conda activate text_fancipy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/text_fancipy.git
   cd text_fancipy
   ```
...
5. Install [pre-commit]:
   ...
   `text_fancipy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/text_fancipy
[issue tracker]: https://github.com/<USERNAME>/text_fancipy/issues
